...
const schema_scripts = []
        ...
        if (yoast_head_json.value && yoast_head_json.value.meta.schema) {
            schema_scripts.push({
                ...
                innerHTML: JSON.stringify(yoast_head_json.value && yoast_head_json.value.meta.schema
        ...
        if (yoast_head_json.value && yoast_head_json.value.product_schema) {
            schema_scripts.push({
                type: 'application/ld+json',
                innerHTML: JSON.stringify(yoast_head_json.value && yoast_head_json.value.product_schema
        ...
        if (yoast_head_json.value && yoast_head_json.value.review_schema) {
            schema_scripts.push({
                type: 'application/ld+json',
                innerHTML: JSON.stringify(yoast_head_json.value && yoast_head_json.value.review_schema
