    ...
    <div class="cf7_379 mt-40">
        <form :action="`${useRuntimeConfig().public.site_url}/wp-json/contact-form-7/v1/contact-forms/223/feedback`" method="post"
            ...
            <p>Your Email (required)<br>
                <span class="wpcf7-form-control-wrap" data-name="your-email"><input type="email" v-bind:valuel="email" name="your-email"
                         size="40"
                        class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email"
                        aria-required="true" aria-invalid="false"></span>
            </p>
            <p>Company Name (required)<br>
                <span class="wpcf7-form-control-wrap" data-name="text-969"><input type="text" v-bind:valuel="company" name="text-969" 
                        size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true"
                        aria-invalid="false"></span>
            </p>
            <p>Phone Number (required)<br>
                <span class="wpcf7-form-control-wrap" data-name="tel-547"><input type="tel" v-bind:valuel="phone" name="tel-547" 
                        size="40"
                        class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel"
                        aria-required="true" aria-invalid="false"></span>
            </p>
            <p>Address (required)<br>
                <span class="wpcf7-form-control-wrap" data-name="text-696"><input type="text" v-bind:valuel="address" name="text-696" 
                        size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true"
                        aria-invalid="false"></span>
            </p>
            <p>Tax ID/EIN # (required) <br>
                <span class="wpcf7-form-control-wrap" data-name="text-289"><input type="text" v-bind:valuel="tax" name="text-289" 
                        size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true"
                        aria-invalid="false"></span></p>
            <p>Message (required)<br><br>
                <span class="wpcf7-form-control-wrap" data-name="textarea-167"><textarea v-bind:valuel="message" name="textarea-167" cols="40"
