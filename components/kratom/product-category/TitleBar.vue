<template>
	<section>
	    <div class="titlebar_section pt-80 pb-140">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="text-center">
							<!--<h2>Best place to buy <span>buy kratom online</span></h2>-->
							<h1 v-html="title"></h1>
						</div>	
					</div>
				</div>
	  ...
	  <div class="after_banner d-none d-md-block">
			<picture>
				...
				<img preload src="/img/kratom/bannerbg-2.png" alt="Kratom Spot Banner"  width="1900" height="917" class="banner_bg"/>
            </picture>
...
body .titlebar_section h2,
body .titlebar_section h1 {
    color: #fff;
    font-size: 50px;
...
.titlebar_section .h2 span, .titlebar_section h2 span {    
    color: #fab333; 
}
#mob-afterbanner {
...
@media only screen and (max-width: 767px) { 
	.titlebar_section { 
    	background-image: url('/img/kratom/titlebar_bg_mob.webp');  
	}
	.titlebar_section h1,
	.titlebar_section h2 { 
		font-size: 24px !important;
	}
	.titlebar_section.pb-sm-70 {
